...
interface FollowButtonProps {
  ...
  /** the target already follows the viewer — one-tap follow-back */
...
export default function FollowButton({
      ...
      default:
        return (
          <>
            ...
            {followsViewer ? 'Follow back' : isPrivate ? 'Request' : 'Follow'}
          </>
        );
    }
  };
  ...
  return (
    <span className="relative inline-flex flex-col items-start">
      ...
      {followsViewer && state === 'none' && (
        <span className="mt-1 text-[11px] font-semibold text-[#6B6B6B]">Follows you</span>
      )}
