...
import ThemeToggle, { THEME_ICONS, THEME_LABELS } from '@/components/ThemeToggle';
...
/* Desktop gets extra quick links; on mobile Communities lives in the bottom
   bar and in the create sheet. */
    ...
    <>
      ...
      <nav className="fixed inset-x-0 top-0 z-50 hidden border-b border-[#E8E2E4] bg-white/90 backdrop-blur md:block">
        <div className="mx-auto flex max-w-6xl items-center justify-end gap-1 px-6 py-2">
          ...
          <ThemeToggle className="ml-1 flex h-9 w-9 items-center justify-center rounded-xl text-[#6B6B6B] transition hover:bg-black/5 [&>svg]:h-4.5 [&>svg]:w-4.5" />
