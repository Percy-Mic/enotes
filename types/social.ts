...
export interface Message {
  ...
  read_at?: string | null;
  /** voice notes: seconds (persisted column) */
...
export interface LiveStream {
  ...
  ended_at?: string | null;
  created_at: string;
  host?: Pick<Profile, 'id' | 'full_text_name' | 'username' | 'avatar_url'>;
}
...
export interface LiveViewerRow {
  ...
  joined_at: string;
  last_seen_at: string;
  viewer?: Pick<Profile, 'id' | 'full_text_name' | 'username' | 'avatar_url'>;
}
