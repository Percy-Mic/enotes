...
import CommunityIconManager from '@/components/community/CommunityIconManager';
...
export default function AdminPage() {
  ...
  return (
    <main className="min-h-[100dvh] bg-[#fff7f8] text-[#171717]">
      ...
      <div className="mx-auto max-w-6xl px-5 py-8 sm:px-6">
        ...
        <div className="mt-7 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <button
            ...
            className="group rounded-3xl border border-black/10 bg-white p-6 text-left shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
          >
            ...
            <p className="mt-2 text-sm leading-6 text-black/50">
              Upload image icons for any community — replaces
              the emoji badge everywhere it appears.
            </p>
      ...
      {iconManagerOpen && <CommunityIconManager onClose={() => setIconManagerOpen(false)} />}
    </main>
  );
}