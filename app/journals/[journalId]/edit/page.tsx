      ...
      >
        ...
        {selected && (
          <>
            ...
            <button type="button" onPointerDown={(e) => e.stopPropagation()} onClick={(e) => { e.stopPropagation(); deleteSelected(); }} className="absolute -right-1 -top-10 rounded-lg bg-white px-2 py-1.5 text-[10px] font-bold text-red-500 shadow"><Trash2 className="mr-1 inline h-3 w-3" /> Delete</button>
